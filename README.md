...
- Command-line–driven administration
- No GUI tooling

## Areas of Focus
- User and group management
- File permissions and ownership
- Service inspection and basic management
- Log inspection and troubleshooting
- Simple automation using shell scripts

## Contents
- `scripts/` — Small automation and diagnostic scripts
